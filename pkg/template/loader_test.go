...
func TestParseRepoURL(t *testing.T) {
	tests := []struct {
		...
		// SSH format
		{
			...
			input:      "git@github.com:NFTGalaxy/bl-template.git",
			wantOwner:  "NFTGalaxy",
		...
		},
		{
			...
			input:      "git@github.com:NFTGalaxy/bl-template.git@main",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "main",
			wantErr:    false,
		},
		{
			...
			input:      "git@github.com:NFTGalaxy/bl-template",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "main",
			wantErr:    false,
		},
		{
			...
			input:      "git@github.com:NFTGalaxy/bl-template@develop",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "develop",
			wantErr:    false,
		...
		// HTTPS format
		{
			...
			input:      "https://github.com/NFTGalaxy/bl-template.git",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "main",
			wantErr:    false,
		},
		{
			...
			input:      "https://github.com/NFTGalaxy/bl-template.git@main",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "main",
			wantErr:    false,
		},
		{
			...
			input:      "https://github.com/NFTGalaxy/bl-template",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "main",
			wantErr:    false,
		},
		{
			...
			input:      "https://github.com/NFTGalaxy/bl-template@develop",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "develop",
			wantErr:    false,
		...
		// Short format
		{
			...
			input:      "github.com/NFTGalaxy/bl-template.git",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "main",
			wantErr:    false,
		},
		{
			...
			input:      "github.com/NFTGalaxy/bl-template.git@main",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "main",
			wantErr:    false,
		},
		{
			...
			input:      "github.com/NFTGalaxy/bl-template",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "main",
			wantErr:    false,
		},
		{
			...
			input:      "github.com/NFTGalaxy/bl-template@develop",
			wantOwner:  "NFTGalaxy",
			wantRepo:   "bl-template",
			wantBranch: "develop",
			wantErr:    false,
...
func TestNormalizeRepoURL(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name:  "SSH format with .git",
			input: "git@github.com:NFTGalaxy/bl-template.git",
			want:  "https://raw.githubusercontent.com/NFTGalaxy/bl-template/main",
		},
		{
			name:  "HTTPS format with .git and branch",
			input: "https://github.com/NFTGalaxy/bl-template.git@develop",
			want:  "https://raw.githubusercontent.com/NFTGalaxy/bl-template/develop",
		},
		{
			name:  "Short format without .git",
			input: "github.com/NFTGalaxy/bl-template",
		...
		},
		{
			...
			input: "github.com/NFTGalaxy/bl-template@feature/test",
			want:  "https://raw.githubusercontent.com/NFTGalaxy/bl-template/feature/test",
		},
	}
...
func TestSanitizeRepoName(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name:  "HTTPS URL",
			input: "https://github.com/NFTGalaxy/bl-template.git",
			want:  "github_com_NFTGalaxy_bl-template_git",
		},
		{
			name:  "SSH URL",
			input: "git@github.com:NFTGalaxy/bl-template.git",
			want:  "git@github_com:NFTGalaxy_bl-template_git",
		},
		{
			name:  "Short format",
			input: "github.com/NFTGalaxy/bl-template",
			want:  "github_com_NFTGalaxy_bl-template",
		},
		{
			name:  "With branch",
			input: "github.com/NFTGalaxy/bl-template@main",
			want:  "github_com_NFTGalaxy_bl-template@main",
		},
	}
