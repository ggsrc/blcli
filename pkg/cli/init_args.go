...
You can then customize the generated file and use it with blcli init --args.`,
  ...
  blcli init-args ./bl-template-one --profile full -o args.yaml`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return generateArgsFile(templateRepoValue, outputPath, finalFormat, org, profile, forceUpdate, cacheExpiry)
		},
	}
...
func generateArgsFile(repoURL, outputPath, format, org, profile string, forceUpdate bool, cacheExpiry time.Duration) error {
