...
本文档约定 blcli 所使用的**模板仓库**的目录结构、配置文件格式与发现规则，供实现或维护模板仓库（如 github.com/ggsrc/bl-template）时遵循。实现对应关系见 `pkg/template/config.go`、`pkg/cli/init_args.go`、`pkg/renderer/argsdef.go`。
...
- 本地路径：绝对路径或相对路径（如克隆后的 `./bl-template`，或 [github.com/ggsrc/bl-template](https://github.com/ggsrc/bl-template) 的本地路径）
...
参考实现：示例模板仓库 [github.com/ggsrc/bl-template](https://github.com/ggsrc/bl-template) 下的 `terraform/`。
...
参考实现：示例模板仓库 [github.com/ggsrc/bl-template](https://github.com/ggsrc/bl-template) 下的 `kubernetes/`。
...
参考实现：示例模板仓库 [github.com/ggsrc/bl-template](https://github.com/ggsrc/bl-template) 下的 `gitops/`。
...
以下为可直接复用的最小示例，与示例模板仓库 [github.com/ggsrc/bl-template](https://github.com/ggsrc/bl-template) 结构兼容。
...
- 参考实现：github.com/ggsrc/bl-template 下的 `terraform/`。
...
- 参考实现：github.com/ggsrc/bl-template 下的 `kubernetes/`。
...
- 参考实现：github.com/ggsrc/bl-template 下的 `gitops/`。

---

**参考实现**：本协议与示例模板仓库 **github.com/ggsrc/bl-template** 结构对齐，实现或扩展模板仓库时可直接参考该仓库作为完整示例。
